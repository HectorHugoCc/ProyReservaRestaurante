		                                ...
		                                <div class="panel-body">
		                                    <div class="form-group">
		                                     ...
		                                     <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_nombre" name="concurso.nombre" placeholder="Ingrese el Nombre" type="text" maxlength="20"/>
		                                        </div>
		                                    </div>
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_fechaInicio">Fecha de inicio</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_fechaInicio" name="concurso.fechaInicio" placeholder="Ingrese la fecha de inicio" type="text" maxlength="10"/>
		                                        </div>
		                                    </div>
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_fechaFin">Fecha de fin</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_fechaFin" name="concurso.fechaFin" placeholder="Ingrese la fecha de inicio" type="text" maxlength="10"/>
		                                        </div>
		                                    </div>    
		                                    <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_estado">Estado</label>
		                                        <div class="col-lg-5">
													<select id="id_estado" name="concurso.estado" class='form-control'>
							                                 <option value="" >[SELECCIONE]</option>
							                                 <option value="Activo">ACTIVO</option>
							                                 <option value="Inactivo">INACTIVO</option>
							                         </select>
